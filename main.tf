resource "aws_instance" "karandeep" {
...
resource "aws_network_interface_sg_attachment" "sg_attachment" {
  ...
  network_interface_id = aws_instance.karandeep.primary_network_interface_id
}
...
resource "aws_volume_attachment" "storage" {
  device_name = "/dev/sdf"
  instance_id = aws_instance.karandeep.id
...
resource "aws_ami_from_instance" "example" {
  name               = var.ami_name
  source_instance_id = aws_instance.karandeep.id
}